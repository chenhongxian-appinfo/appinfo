...
$(".addVersion").on(
		...
		function() {
			var obj = $(this);
			window.location.href = "../version/verindex.html?id="
					+ obj.attr("appinfoid");
		});
				...
				function() {
					...
					if (status == "1" || status == "3") {// 待审核、审核未通过状态下才可以进行修改操作
						if (versionid == null || versionid == "") {
							...
							window.location.href = "../version/updataVersionindex.html?vid="
...
$(".modifyAppInfo").on(
		...
		function() {
			...
			var status = obj.attr("status");
			if (status == "1" || status == "3") {// 待审核、审核未通过状态下才可以进行修改操作
				window.location.href = "../appinfo/updataAppinfpIndex.html?id="
						+ obj.attr("appinfoid");
			} else {
...
var saleSwitchAjax = function(appId, obj) {
	$
			.ajax({
				type : "PUT",
				url : "../appinfo/updateAppType?Appid=" + appId,
				dataType : "json",
...
$(".viewApp").on(
		...
		function() {
			var obj = $(this);
			window.location.href = "../appinfo/selectAppinfoById.html?id="
					+ obj.attr("appinfoid");
		});
