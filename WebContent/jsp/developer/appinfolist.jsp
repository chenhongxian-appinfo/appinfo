...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post"
					action="${pageContext.request.contextPath}/appinfo/page.html">
					...
					<ul>
						...
						<li>
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select name="PcNameID" class="form-control">
						...
						<li>
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select id="queryCategoryLevel1" name="classify1"
										class="form-control">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="hidden" name="categorylevel2list"
										id="categorylevel2list" /> <select name="classify2"
						...
						<li>
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select name="classify3" id="queryCategoryLevel3"
										class="form-control">
			...
			<div class="x_content">
				...
				<div id="datatable-responsive_wrapper"
					...
					<div class="row">
						<div class="col-sm-12">
							<a
								href="${pageContext.request.contextPath}/appinfo/addindex.html"
